...
var author$project$Main$checkItem = F3(
	function (indexToCheck, index, todo) {
		return _Utils_eq(indexToCheck, index) ? _Utils_update(
			todo,
					...
					_Utils_update(
						model,
						{
							todos: A2(
								...
								author$project$Main$checkItem(index),
								model.todos)
						}),
					...
					_Utils_update(
						model,
						{
							...
							todos: _Utils_ap(
								...
								_List_fromArray(
									[
										{content: model.search, isDone: false}
									]))
						}),
			...
			default:
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{response: author$project$Main$Failure}),
						elm$core$Platform$Cmd$none);
				}
		}
	});
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A2(elm$html$Html$Attributes$style, 'margin-right', '25%'),
						A2(elm$html$Html$Attributes$style, 'display', 'flex'),
						A2(elm$html$Html$Attributes$style, 'flex-direction', 'column')
					]),
				_List_fromArray(
					[
						author$project$Header$header,
						A2(
						elm$html$Html$div,
						_List_fromArray(
							[
