...
var $author$project$Main$checkItem = F2(
	function (idToCheck, todo) {
		return _Utils_eq(idToCheck, todo.id) ? _Utils_update(
			todo,
	...
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'MainTest',
				_List_fromArray(
					[$author$project$MainTest$checkTodosTest, $author$project$MainTest$deleteDoneTodosTest, $author$project$MainTest$deleteTodoTest]))
			])));
_Platform_export({'Test':{'Generated':{'Main1504243930':{'init':$author$project$Test$Generated$Main1504243930$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
