    ...
    function _Debug_crash(identifier, fact1, fact2, fact3, fact4) {
      switch (identifier) {
        ...
        case 3:
          var portName = fact1;
          throw new Error(
            "There can only be one port named `" + portName +
      ...
      switch (decoder.$) {
        ...
        case 7:
          ...
          if (index >= value.length) {
            return _Json_expecting(
              "a LONGER array. Need index " + index + " but only see " +
        ...
        case 8:
          if (
            typeof value !== "object" || value === null || _Json_isArray(value)
          ) {
...
type alias Process =
  ...
  , mailbox : [msg]
    ...
    */
    ...
    var _Platform_worker = F4(
      function (impl, flagDecoder, debugMetadata, args) {
    ...
    var $author$project$Main$checkItem = F2(
      function (idToCheck, todo) {
        return _Utils_eq(idToCheck, todo.id)
          ? _Utils_update(
            todo,
            { isDone: !todo.isDone },
          )
    ...
    var $elm_explorations$test$Test$Runner$Failure$BadDescription = {
      $: "BadDescription",
    };
    var $elm_explorations$test$Test$Internal$Batch = function (a) {
      return { $: "Batch", a: a };
    };
    var $elm_explorations$test$Test$Runner$Failure$DuplicatedName = {
      $: "DuplicatedName",
    };
    var $elm_explorations$test$Test$Runner$Failure$EmptyList = {
      $: "EmptyList",
    };
    ...
    var $elm$core$Set$empty = $elm$core$Set$Set_elm_builtin(
      $elm$core$Dict$empty,
    );
    ...
    var $elm$core$Dict$balance = F5(
      function (color, key, value, left, right) {
        if ((right.$ === "RBNode_elm_builtin") && (right.a.$ === "Red")) {
          ...
          if (
            (((left.$ === "RBNode_elm_builtin") && (left.a.$ === "Red")) &&
              (left.d.$ === "RBNode_elm_builtin")) && (left.d.a.$ === "Red")
          ) {
            var _v5 = left.a;
            var lK = left.b;
            var lV = left.c;
    ...
    var $elm_explorations$test$Test$Internal$duplicatedName = function () {
      ...
      var insertOrFail = function (newName) {
        return $elm$core$Result$andThen(
          function (oldNames) {
            return A2($elm$core$Set$member, newName, oldNames)
              ? $elm$core$Result$Err(newName)
              : $elm$core$Result$Ok(
      ...
      function (untrimmedDesc, tests) {
        ...
        if ($elm$core$String$isEmpty(desc)) {
          return $elm_explorations$test$Test$Internal$failNow(
            {
              ...
              reason: $elm_explorations$test$Test$Runner$Failure$Invalid(
                $elm_explorations$test$Test$Runner$Failure$BadDescription,
              ),
            },
          );
        } else {
          if ($elm$core$List$isEmpty(tests)) {
            return $elm_explorations$test$Test$Internal$failNow(
              {
                description: "This `describe " +
                  (desc + "` has no tests in it. Let's give it some!"),
                reason: $elm_explorations$test$Test$Runner$Failure$Invalid(
            ...
            var _v0 = $elm_explorations$test$Test$Internal$duplicatedName(
              tests,
            );
            if (_v0.$ === "Err") {
              var duped = _v0.a;
              return $elm_explorations$test$Test$Internal$failNow(
                {
                  ...
                  reason: $elm_explorations$test$Test$Runner$Failure$Invalid(
                    $elm_explorations$test$Test$Runner$Failure$DuplicatedName,
                  ),
                },
              );
            } else {
              var childrenNames = _v0.a;
              return A2($elm$core$Set$member, desc, childrenNames)
                ? $elm_explorations$test$Test$Internal$failNow(
                  {
                    description: "The test '" +
                      (desc +
                        "' contains a child test of the same name. Let's rename them so we know which is which."),
                    reason: $elm_explorations$test$Test$Runner$Failure$Invalid(
                      $elm_explorations$test$Test$Runner$Failure$DuplicatedName,
                    ),
                  },
    ...
    var $elm_explorations$test$Expect$fail = function (str) {
      return $elm_explorations$test$Test$Expectation$fail(
        {
          description: str,
          reason: $elm_explorations$test$Test$Runner$Failure$Custom,
        },
      );
    };
    var $elm$core$Basics$or = _Basics_or;
    var $elm_explorations$test$Test$Expectation$Pass = { $: "Pass" };
    var $elm_explorations$test$Expect$pass =
    ...
    var $elm_explorations$test$Expect$testWith = F5(
      function (makeReason, label, runTest, expected, actual) {
        return A2(runTest, actual, expected)
          ? $elm_explorations$test$Expect$pass
          : $elm_explorations$test$Test$Expectation$fail(
            {
              description: label,
              reason: A2(
                makeReason,
    ...
    var $elm_explorations$test$Expect$equateWith = F4(
      function (reason, comparison, b, a) {
        ...
        var usesFloats = isFloat(
          $elm_explorations$test$Test$Internal$toString(a),
        ) || isFloat(
          $elm_explorations$test$Test$Internal$toString(b),
        );
        var floatError = A2($elm$core$String$contains, reason, "not")
        ...
        return usesFloats ? $elm_explorations$test$Expect$fail(floatError) : A5(
          $elm_explorations$test$Expect$testWith,
    ...
    var $elm_explorations$test$Expect$equal = A2(
      $elm_explorations$test$Expect$equateWith,
      "Expect.equal",
      $elm$core$Basics$eq,
    );
    var $author$project$MainTest$mockTodo = function (id) {
      return { content: "", id: id, isDone: false };
    };
    var $elm_explorations$test$Test$Internal$blankDescriptionFailure =
      $elm_explorations$test$Test$Internal$failNow(
        {
          description:
    ...
    var $elm_explorations$test$Test$test = F2(
      function (untrimmedDesc, thunk) {
        var desc = $elm$core$String$trim(untrimmedDesc);
        return $elm$core$String$isEmpty(desc)
          ? $elm_explorations$test$Test$Internal$blankDescriptionFailure
          : A2(
            $elm_explorations$test$Test$Internal$Labeled,
            desc,
    ...
    var $author$project$MainTest$checkTodosTest = A2(
      ...
      _List_fromArray(
        [
          A2(
            ...
            "returns the checked todo",
            function (_v0) {
              return A2(
                $elm_explorations$test$Expect$equal,
                { content: "", id: "id", isDone: true },
                A2(
                  $author$project$Main$checkItem,
                  "id",
                  $author$project$MainTest$mockTodo("id"),
                ),
              );
            },
          ),
          A2(
            $elm_explorations$test$Test$test,
            "returns same todo when ids do not match",
            function (_v1) {
              return A2(
                $elm_explorations$test$Expect$equal,
                $author$project$MainTest$mockTodo("someId"),
                A2(
                  $author$project$Main$checkItem,
                  "id",
                  $author$project$MainTest$mockTodo("someId"),
    ...
    var $elm_explorations$test$Test$concat = function (tests) {
      if ($elm$core$List$isEmpty(tests)) {
        return $elm_explorations$test$Test$Internal$failNow(
          {
            description:
              "This `concat` has no tests in it. Let's give it some!",
            reason: $elm_explorations$test$Test$Runner$Failure$Invalid(
              $elm_explorations$test$Test$Runner$Failure$EmptyList,
            ),
          },
        ...
        if (_v0.$ === "Err") {
          ...
          return $elm_explorations$test$Test$Internal$failNow(
            {
              description: "A test group contains multiple tests named '" +
                (duped +
    ...
    var $author$project$Main$deleteFinishedTodos = function (todos) {
      return A2(
    ...
    var $author$project$MainTest$mockTodoList = F2(
      function (firstId, secondId) {
        return _List_fromArray(
          [
            { content: "one", id: firstId, isDone: false },
            { content: "one", id: secondId, isDone: true },
          ],
        );
      },
    );
    var $author$project$MainTest$deleteDoneTodosTest = A2(
      $elm_explorations$test$Test$describe,
            ...
            function (_v0) {
              return A2(
                ...
                A2(
                  ...
                  $author$project$Main$deleteFinishedTodos(
                    A2($author$project$MainTest$mockTodoList, "id1", "id2"),
                  ),
                ),
              );
            },
    ...
    var $author$project$Main$removeTodoById = F2(
      function (id, todos) {
        return A2(
          $elm$core$List$filter,
          function (todo) {
            return !_Utils_eq(todo.id, id);
          },
          todos,
        );
      },
    );
    var $author$project$MainTest$deleteTodoTest = A2(
      $elm_explorations$test$Test$describe,
      "Delete todo",
      _List_fromArray(
        [
            ...
            function (_v0) {
              return A2(
                ...
                $elm$core$List$length(
                  A2(
                    $author$project$Main$removeTodoById,
                    "id2",
                    A2($author$project$MainTest$mockTodoList, "id1", "id2"),
                  ),
                ),
          ...
          A2(
            $elm_explorations$test$Test$test,
            "returns the same list for wrong id",
            function (_v1) {
              return A2(
                $elm_explorations$test$Expect$equal,
                2,
    ...
    var $elm$core$Char$isAlphaNum = function (_char) {
      return $elm$core$Char$isLower(_char) ||
            ...
            case "OneOf":
              ...
              if (!errors.b) {
                ...
                if (!errors.b.b) {
                  ...
                  var introduction = starter +
                    (" failed in the following " + ($elm$core$String$fromInt(
    ...
    var $elm_explorations$test$Test$Runner$countRunnables = function (
      runnable,
    ) {
      countRunnables:
      while (true) {
        switch (runnable.$) {
          ...
          default:
            ...
            return $elm_explorations$test$Test$Runner$cyclic$countAllRunnables()(
              runners,
            );
        }
      }
    ...
    function $elm_explorations$test$Test$Runner$cyclic$countAllRunnables() {
      return A2(
        ...
        A2(
          $elm$core$Basics$composeR,
          $elm_explorations$test$Test$Runner$countRunnables,
          $elm$core$Basics$add,
        ),
        0,
      );
    ...
    try {
      var $elm_explorations$test$Test$Runner$countAllRunnables =
        $elm_explorations$test$Test$Runner$cyclic$countAllRunnables();
      $elm_explorations$test$Test$Runner$cyclic$countAllRunnables =
        function () {
    ...
    var $elm$random$Random$next = function (_v0) {
      ...
      var incr = _v0.b;
      return A2(
        $elm$random$Random$Seed,
        ((state0 * 1664525) + incr) >>> 0,
        incr,
      );
    };
    ...
    var $elm_explorations$test$Test$Runner$batchDistribute = F4(
      function (hashed, runs, test, prev) {
        var next = A4(
          $elm_explorations$test$Test$Runner$distributeSeedsHelp,
          hashed,
          runs,
          prev.seed,
          test,
        ...
        switch (test.$) {
            ...
            if (hashed) {
              ...
              var hashedSeed = $elm$random$Random$initialSeed(
                A2(
                  ...
                  intFromSeed,
                  A2(
                    $elm_explorations$test$Test$Runner$fnvHashString,
                    $elm_explorations$test$Test$Runner$fnvInit,
                    description,
                  ),
                ),
              );
          ...
          default:
            ...
            return A3(
              $elm$core$List$foldl,
              A2(
                $elm_explorations$test$Test$Runner$batchDistribute,
                hashed,
                runs,
              ),
    ...
    var $elm_explorations$test$Test$Runner$distributeSeeds =
      $elm_explorations$test$Test$Runner$distributeSeedsHelp(false);
    ...
    var $elm_explorations$test$Test$Runner$run = function (_v0) {
      ...
      if (_v1.$ === "Ok") {
        ...
        return _List_fromArray(
          [
            $elm_explorations$test$Expect$fail(
              'This test failed because it threw an exception: \"' +
                (message + '\"'),
            ),
          ],
        );
    ...
    var $elm_explorations$test$Test$Runner$fromRunnableTree =
      $elm_explorations$test$Test$Runner$fromRunnableTreeHelp(_List_Nil);
        ...
        if (runs < 1) {
          return $elm_explorations$test$Test$Runner$Invalid(
            "Test runner run count must be at least 1, not " +
              $elm$core$String$fromInt(runs),
          );
        } else {
          var distribution = A3(
            $elm_explorations$test$Test$Runner$distributeSeeds,
            runs,
            seed,
            test,
          );
          return $elm$core$List$isEmpty(distribution.only)
            ? ((!$elm_explorations$test$Test$Runner$countAllRunnables(
                distribution.skipped,
              ))
              ? $elm_explorations$test$Test$Runner$Plain(
                A2(
                  $elm$core$List$concatMap,
                  $elm_explorations$test$Test$Runner$fromRunnableTree,
                  distribution.all,
                ),
              )
              : $elm_explorations$test$Test$Runner$Skipping(
                A2(
                  $elm$core$List$concatMap,
                  $elm_explorations$test$Test$Runner$fromRunnableTree,
                  distribution.all,
            ...
            : $elm_explorations$test$Test$Runner$Only(
              A2(
                $elm$core$List$concatMap,
                $elm_explorations$test$Test$Runner$fromRunnableTree,
                distribution.only,
    ...
    var $author$project$Console$Text$plain = $author$project$Console$Text$Text(
      {
        background: $author$project$Console$Text$Default,
        foreground: $author$project$Console$Text$Default,
        modifiers: _List_Nil,
        style: $author$project$Console$Text$Normal,
      },
    );
    ...
    var $author$project$Test$Runner$Node$Vendor$Console$colorsInverted =
      function (str) {
        return A2(
          $elm$core$String$join,
          "",
    ...
    var $author$project$Console$Text$applyModifiersHelp = F2(
      function (modifier, str) {
        if (modifier.$ === "Inverted") {
          return $author$project$Test$Runner$Node$Vendor$Console$colorsInverted(
            str,
          );
        } else {
    ...
    var $author$project$Console$Text$applyModifiers = F2(
      function (modifiers, str) {
        return A3(
          $elm$core$List$foldl,
          $author$project$Console$Text$applyModifiersHelp,
          str,
          modifiers,
        );
      },
    ...
    var $author$project$Test$Runner$Node$Vendor$Console$underline = function (
      str,
    ) {
      return A2(
        $elm$core$String$join,
    ...
    var $author$project$Console$Text$applyStyle = F2(
      function (style, str) {
        switch (style.$) {
          ...
          default:
            return $author$project$Test$Runner$Node$Vendor$Console$underline(
              str,
            );
        }
      },
    );
    var $author$project$Test$Runner$Node$Vendor$Console$bgBlack = function (
      str,
    ) {
      return A2(
        $elm$core$String$join,
    ...
    var $author$project$Test$Runner$Node$Vendor$Console$bgBlue = function (
      str,
    ) {
      return A2(
        $elm$core$String$join,
    ...
    var $author$project$Test$Runner$Node$Vendor$Console$bgCyan = function (
      str,
    ) {
      return A2(
        $elm$core$String$join,
    ...
    var $author$project$Test$Runner$Node$Vendor$Console$bgGreen = function (
      str,
    ) {
      return A2(
        $elm$core$String$join,
    ...
    var $author$project$Test$Runner$Node$Vendor$Console$bgMagenta = function (
      str,
    ) {
      return A2(
        $elm$core$String$join,
    ...
    var $author$project$Test$Runner$Node$Vendor$Console$bgWhite = function (
      str,
    ) {
      return A2(
        $elm$core$String$join,
    ...
    var $author$project$Test$Runner$Node$Vendor$Console$bgYellow = function (
      str,
    ) {
      return A2(
        $elm$core$String$join,
    ...
    var $author$project$Console$Text$colorizeBackground = F2(
      function (color, str) {
        switch (color.$) {
          ...
          case "Yellow":
            return $author$project$Test$Runner$Node$Vendor$Console$bgYellow(
              str,
            );
          case "Black":
          ...
          case "Magenta":
            return $author$project$Test$Runner$Node$Vendor$Console$bgMagenta(
              str,
            );
          case "Cyan":
    ...
    var $author$project$Test$Runner$Node$Vendor$Console$magenta = function (
      str,
    ) {
      return A2(
        $elm$core$String$join,
    ...
    var $author$project$Test$Runner$Node$Vendor$Console$yellow = function (
      str,
    ) {
      return A2(
        $elm$core$String$join,
            ...
            return A2(
              ...
              A2(
                ...
                A2(
                  ...
                  attrs.foreground,
                  A2(
                    $author$project$Console$Text$colorizeBackground,
                    attrs.background,
                    str,
                  ),
                ),
    ...
    var $author$project$Test$Reporter$Console$reportBegin = F2(
      function (useColor, _v0) {
        ...
        var prefix = "Running " +
          (A3(
            $author$project$Test$Reporter$Console$pluralize,
            "test",
            "tests",
            testCount,
          ) +
            (". To reproduce these results, run: elm-test --fuzz " +
              ($elm$core$String$fromInt(fuzzRuns) +
                (" --seed " + $elm$core$String$fromInt(initialSeed)))));
    ...
    var $author$project$Console$Text$concat =
      $author$project$Console$Text$Texts;
    ...
    var $author$project$Console$Text$red = $author$project$Console$Text$Text(
      {
        background: $author$project$Console$Text$Default,
        foreground: $author$project$Console$Text$Red,
        modifiers: _List_Nil,
        style: $author$project$Console$Text$Normal,
      },
    );
    ...
    var $elm$core$Array$bitMask = 4294967295 >>>
      (32 - $elm$core$Array$shiftStep);
              ...
              if (_Utils_eq(x - 1, prevX) && _Utils_eq(y - 1, prevY)) {
                ...
                if (_Utils_eq(x, prevX)) {
                  ...
                  if (_v5.$ === "Just") {
                    ...
                    return $elm$core$Result$Err(
                      $author$project$Test$Runner$Node$Vendor$Diff$CannotGetB(
                        y,
                      ),
                    );
                  }
                  ...
                  if (_Utils_eq(y, prevY)) {
                    ...
                    if (_v6.$ === "Just") {
                      ...
                      return $elm$core$Result$Err(
                        $author$project$Test$Runner$Node$Vendor$Diff$CannotGetA(
                          x,
                        ),
                      );
                    }
    ...
    var $author$project$Test$Runner$Node$Vendor$Diff$step = F4(
      function (snake_, offset, k, v) {
        ...
        var _v0 = function () {
          ...
          if (!_v2.a.b) {
            ...
            if (!_v2.b.b) {
              ...
              var topX = _v10.a;
              var topY = _v10.b;
              return (_Utils_cmp(leftY + 1, topY) > -1)
                ? _Utils_Tuple2(
                  fromLeft,
                  _Utils_Tuple2(leftX, leftY + 1),
                )
        ...
        var goal = _v11.b;
        return goal
          ? $author$project$Test$Runner$Node$Vendor$Diff$Found(newPath)
          : $author$project$Test$Runner$Node$Vendor$Diff$Continue(
      ...
      function (snake_, offset, ks, v) {
        ...
        while (true) {
          if (!ks.b) {
            ...
            var ks_ = ks.b;
            var _v1 = A4(
              $author$project$Test$Runner$Node$Vendor$Diff$step,
              snake_,
              offset,
              k,
              v,
        ...
        while (true) {
          var ks = (delta > 0)
            ? _Utils_ap(
              ...
              A2($elm$core$List$range, -p, delta),
            )
            : _Utils_ap(
              $elm$core$List$reverse(
          ...
          var _v0 = A4(
            $author$project$Test$Runner$Node$Vendor$Diff$onpLoopK,
            snake_,
            offset,
            ks,
            v,
    ...
    var $author$project$Test$Runner$Node$Vendor$Diff$testDiff = F2(
      function (a, b) {
        ...
        var path = A4(
          $author$project$Test$Runner$Node$Vendor$Diff$onp,
          getA,
          getB,
          m,
          n,
        ...
        return A3(
          $author$project$Test$Runner$Node$Vendor$Diff$makeChanges,
          getA,
          getB,
          path,
        );
    ...
    var $author$project$Test$Runner$Node$Vendor$Diff$diff = F2(
      function (a, b) {
        var _v0 = A2(
          $author$project$Test$Runner$Node$Vendor$Diff$testDiff,
          a,
          b,
        );
        if (_v0.$ === "Ok") {
    ...
    var $author$project$Test$Reporter$Highlightable$diffLists = F2(
      function (expected, actual) {
        return A2(
          ...
          A2(
            $author$project$Test$Runner$Node$Vendor$Diff$diff,
            expected,
            actual,
          ),
        );
    ...
    var $author$project$Test$Reporter$Console$Format$highlightEqual = F2(
      function (expected, actual) {
        if ((expected === '\"\"') || (actual === '\"\"')) {
          ...
          if (
            $author$project$Test$Reporter$Console$Format$isFloat(expected) &&
            $author$project$Test$Reporter$Console$Format$isFloat(actual)
          ) {
            return $elm$core$Maybe$Nothing;
          } else {
            var isHighlighted =
              $author$project$Test$Reporter$Highlightable$resolve(
                {
            ...
            var highlightedActual = A2(
              $elm$core$List$map,
              $author$project$Test$Reporter$Highlightable$map(
                $elm$core$String$fromChar,
              ),
              A2(
                $author$project$Test$Reporter$Highlightable$diffLists,
                actualChars,
                expectedChars,
              ),
            );
      ...
      function (formatEquality, description, reason) {
        switch (reason.$) {
          ...
          case "Equality":
            ...
            var actual = reason.b;
            var _v1 = A2(
              $author$project$Test$Reporter$Console$Format$highlightEqual,
              expected,
              actual,
            );
            if (_v1.$ === "Nothing") {
    ...
    var $author$project$Test$Reporter$Console$Format$Color$fromHighlightable =
      $author$project$Test$Reporter$Highlightable$resolve(
        {
          fromHighlighted:
            $author$project$Test$Runner$Node$Vendor$Console$colorsInverted,
          fromPlain: $elm$core$Basics$identity,
        },
      );
    var $author$project$Test$Reporter$Console$Format$Color$formatEquality = F2(
      function (highlightedExpected, highlightedActual) {
        var formattedExpected = A2(
          ...
          A2(
            $elm$core$List$map,
            $author$project$Test$Reporter$Console$Format$Color$fromHighlightable,
            highlightedExpected,
          ),
        );
    ...
    var $author$project$Test$Reporter$Console$Format$Monochrome$fromHighlightable =
      function (indicator) {
    ...
    var $author$project$Test$Reporter$Console$Format$Monochrome$formatEquality =
      F2(
        function (highlightedExpected, highlightedActual) {
      ...
      function (useColor, _v0) {
        ...
        var messageText = $author$project$Console$Text$plain(
          "\n" + ($author$project$Test$Reporter$Console$indent(
            A3(
              $author$project$Test$Reporter$Console$Format$format,
              formatEquality,
              description,
              reason,
            ),
        ...
        switch (outcome.$) {
          ...
          case "Failed":
            ...
            return A2(
              ...
              useColor,
              A3(
                $author$project$Test$Reporter$Console$failuresToText,
                useColor,
                labels,
                failures,
              ),
    ...
    var $author$project$Test$Reporter$JUnit$encodeFailureTuple = function (
      message,
    ) {
      return _Utils_Tuple2(
        "failure",
    ...
    var $author$project$Test$Reporter$JUnit$formatFailure = function (_v0) {
      ...
      var reason = _v0.reason;
      var message = A2(
        $author$project$Test$Reporter$JUnit$reasonToString,
        description,
        reason,
      );
      if (given.$ === "Just") {
      ...
      switch (outcome.$) {
        ...
        case "Failed":
          ...
          var message = A2(
            ...
            A2(
              $elm$core$List$map,
              $author$project$Test$Reporter$JUnit$formatFailure,
              failures,
            ),
          );
          return _List_fromArray(
        ...
        default:
          ...
          return _List_fromArray(
            [
              $author$project$Test$Reporter$JUnit$encodeFailureTuple(
                "TODO: " + message,
              ),
            ],
          );
    ...
    var $author$project$Test$Reporter$JUnit$formatClassAndName = function (
      labels,
    ) {
      if (labels.b) {
        var head = labels.a;
        ...
        _List_fromArray(
          [
            ...
            _Utils_Tuple2(
              "reason",
              A2(
                $author$project$Test$Reporter$Json$encodeReason,
                description,
                reason,
              ),
            ),
    ...
    var $author$project$Test$Reporter$Json$encodeFailures = function (outcome) {
      switch (outcome.$) {
        case "Failed":
          ...
          return A2(
            $elm$core$List$map,
            $author$project$Test$Reporter$Json$encodeFailure,
            failures,
          );
        case "Todo":
          var str = outcome.a;
    ...
    var $author$project$Console$Text$green = $author$project$Console$Text$Text(
      {
        background: $author$project$Console$Text$Default,
        foreground: $author$project$Console$Text$Green,
        modifiers: _List_Nil,
        style: $author$project$Console$Text$Normal,
      },
    );
    ...
    var $author$project$Console$Text$yellow = $author$project$Console$Text$Text(
      {
        background: $author$project$Console$Text$Default,
        foreground: $author$project$Console$Text$Yellow,
        modifiers: _List_Nil,
        style: $author$project$Console$Text$Normal,
      },
    );
    var $author$project$Test$Reporter$Console$reportSummary = F3(
      function (useColor, _v0, autoFail) {
        ...
        var individualTodos = (failed > 0)
          ? $author$project$Console$Text$plain("")
          : $author$project$Test$Reporter$Console$summarizeTodos(
                  ...
                  case 1:
                    ...
                    return $elm$core$Result$Err(
                      _Utils_Tuple3(
                        ...
                        "TEST RUN INCOMPLETE",
                        " because there is 1 TODO remaining",
                      ),
                    );
                  default:
                    var _v6 = _v3.a;
              ...
              _List_fromArray(
                [
                  ...
                  A2(
                    $author$project$Test$Reporter$Console$stat,
                    "Duration: ",
                    $author$project$Test$Reporter$Console$formatDuration(
                      duration,
                    ),
                  ),
                  A2(
    ...
    var $author$project$Test$Reporter$JUnit$encodeExtraFailure = function (
      _v0,
    ) {
    ...
    var $author$project$Test$Reporter$Reporter$createReporter = function (
      report,
    ) {
      switch (report.$) {
        case "JsonReport":
          return A4(
            ...
            "JSON",
            $author$project$Test$Reporter$Json$reportBegin,
            $author$project$Test$Reporter$Json$reportComplete,
            $author$project$Test$Reporter$Json$reportSummary,
          );
        case "ConsoleReport":
        ...
        default:
          return A4(
            $author$project$Test$Reporter$Reporter$TestReporter,
            "JUNIT",
            $author$project$Test$Reporter$JUnit$reportBegin,
            $author$project$Test$Reporter$JUnit$reportComplete,
            $author$project$Test$Reporter$JUnit$reportSummary,
          );
      }
    };
    ...
    var $author$project$Test$Runner$Node$init = F2(
      function (_v0, _v1) {
        ...
        var testReporter =
          $author$project$Test$Reporter$Reporter$createReporter(report);
        var _v2 = function () {
          switch (runners.$) {
            case "Plain":
    ...
    var $author$project$Test$Runner$Node$receive = _Platform_incomingPort(
      "receive",
    ...
    var $author$project$Test$Runner$JsMessage$decodeMessageFromType = function (
      messageType,
    ) {
      switch (messageType) {
        case "TEST":
          ...
          return A4(
            ...
            A2(
              ...
              $elm$json$Json$Decode$list(
                $author$project$Test$Runner$JsMessage$todoDecoder,
              ),
            ),
          );
        default:
    ...
    var $elm_explorations$test$Test$Runner$getFailureReason = function (
      expectation,
    ) {
      if (expectation.$ === "Pass") {
        return $elm$core$Maybe$Nothing;
    ...
    var $elm_explorations$test$Test$Runner$isTodo = function (expectation) {
      if (expectation.$ === "Pass") {
        ...
        return _Utils_eq(
          reason,
          $elm_explorations$test$Test$Runner$Failure$TODO,
        );
      }
    };
    var $author$project$Test$Reporter$TestResults$outcomesFromExpectationsHelp =
      F2(
        function (expectation, builder) {
          ...
          if (_v0.$ === "Just") {
            var failure = _v0.a;
            return $elm_explorations$test$Test$Runner$isTodo(expectation)
              ? _Utils_update(
                builder,
                {
                  todos: A2(
    ...
    var $author$project$Test$Reporter$TestResults$outcomesFromExpectations =
          ...
          if (!expectations.b.b) {
            ...
            if (_v1.$ === "Nothing") {
              ...
              return $elm_explorations$test$Test$Runner$isTodo(expectation)
                ? _List_fromArray(
                  [
                    $author$project$Test$Reporter$TestResults$Todo(
                      failure.description,
                    ),
                  ],
                )
    ...
    var $author$project$Test$Runner$Node$send = _Platform_outgoingPort(
      "send",
      $elm$json$Json$Encode$string,
    );
    ...
    var $author$project$Test$Runner$Node$dispatch = F2(
      function (model, startTime) {
        ...
        if (_v0.$ === "Nothing") {
          return A3(
            $author$project$Test$Runner$Node$sendResults,
            true,
            model.testReporter,
            model.results,
          );
          ...
          var config = _v0.a;
          var outcomes =
            $author$project$Test$Reporter$TestResults$outcomesFromExpectations(
              config.run(_Utils_Tuple0),
            );
          return A2(
            $elm$core$Task$perform,
            A3(
              $author$project$Test$Runner$Node$Complete,
              config.labels,
              outcomes,
              startTime,
            ),
    ...
    var $author$project$Test$Reporter$TestResults$isFailure = function (
      outcome,
    ) {
      if (outcome.$ === "Failed") {
        return true;
        ...
        switch (msg.$) {
          case "Receive":
            ...
            var _v1 = A2(
              ...
              $author$project$Test$Runner$JsMessage$decoder,
              val,
            );
            if (_v1.$ === "Ok") {
              if (_v1.a.$ === "Summary") {
                ...
                var exitCode = (failed > 0)
                  ? 2
                  : ((_Utils_eq(model.autoFail, $elm$core$Maybe$Nothing) &&
                      $elm$core$List$isEmpty(todos))
                    ? 0
                    : 3);
                ...
                var cmd = A2(
                  $elm$core$Task$perform,
                  $author$project$Test$Runner$Node$Dispatch,
                  $elm$time$Time$now,
                );
                return _Utils_eq(index, -1)
                  ? _Utils_Tuple2(
                    _Utils_update(
                      model,
          ...
          default:
            ...
            var isFinished =
              _Utils_cmp(nextTestToRun, model.runInfo.testCount) > -1;
            var duration = $elm$time$Time$posixToMillis(endTime) -
            ...
            if (
              ...
              A2(
                $elm$core$List$any,
                $author$project$Test$Reporter$TestResults$isFailure,
                outcomes,
              )
            ) {
              var cmd = A3(
    ...
    var $author$project$Test$Runner$Node$run = F2(
      function (_v0, test) {
        ...
        var fuzzRuns = A2(
          $elm$core$Maybe$withDefault,
          $author$project$Test$Runner$Node$defaultRunCount,
          runs,
        );
        var runners = A3(
        ...
        return $elm$core$Platform$worker(
          {
            ...
            subscriptions: function (_v1) {
              return $author$project$Test$Runner$Node$receive(
                $author$project$Test$Runner$Node$Receive,
              );
            },
    ...
    var $author$project$Test$Generated$Main1504243930$main = A2(
      $author$project$Test$Runner$Node$run,
      {
        globs: _List_Nil,
        paths: _List_fromArray(
          ["/Users/dor/Workspace/ElmTodos/client/tests/MainTest.elm"],
        ),
        processes: 12,
        report: $author$project$Test$Reporter$Reporter$ConsoleReport(
          $author$project$Console$Text$UseColor,
        ),
        runs: $elm$core$Maybe$Nothing,
        seed: 366167565188725,
      },
        ...
        _List_fromArray(
          [
            A2(
              ...
              _List_fromArray(
                [
                  $author$project$MainTest$checkTodosTest,
                  $author$project$MainTest$deleteDoneTodosTest,
                  $author$project$MainTest$deleteTodoTest,
                ],
              ),
            ),
          ],
    ...
    _Platform_export(
      {
        "Test": {
          "Generated": {
            "Main1504243930": {
              "init": $author$project$Test$Generated$Main1504243930$main(
                $elm$json$Json$Decode$int,
              )(0),
            },
          },
...
var pipeFilename = "/tmp/elm_test-8894.sock";
